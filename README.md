...
/codex:rescue --model sol --effort max audit the authentication redesign
/codex:rescue --model luna classify the failing tests by likely owner
...
- `sol`, `terra`, and `luna` map to `gpt-5.6-sol`, `gpt-5.6-terra`, and `gpt-5.6-luna`.

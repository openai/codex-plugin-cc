...
- SessionEnd cleanup now fences and stops the session's workers before waiting on the state lock, bounds that wait and the broker shutdown request well below the hook timeout, and keeps going past unreadable jobs or state.

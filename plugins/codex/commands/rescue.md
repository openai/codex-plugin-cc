...
argument-hint: "[--background|--wait] [--resume|--fresh] [--model <model|spark>] [--effort <none|minimal|low|medium|high|xhigh|ultra|max>] [what Codex should investigate, solve, or continue]"

...
test("rescue command absorbs continue semantics", () => {
  ...
  assert.match(rescue, /--external-sandbox/);
  ...
  assert.match(rescue, /`--model`, `--effort`, and `--external-sandbox` are runtime-selection flags/i);
  ...
  assert.match(agent, /`--external-sandbox` as runtime controls/i);
  ...
  assert.match(runtimeSkill, /includes `--external-sandbox`, pass it through to `task`/i);
